...
var DatePickerDialog = function (cdp) {
  this.buttonLabelChoose = '날짜 선택';
  this.buttonLabelChange = '날짜 변경';
  this.dayLabels = [
    'Sunday',
    'Monday',
    'Tuesday',
  ...
  this.messageCursorKeys = '방향키로 날짜를 탐색할 수 있습니다';
  this.lastMessage = '';
...
//     '<div class="header">' +
//         '<button type="button" class="prev-year" aria-label="이전 해">' +
//             '<span class="fas fa-angle-double-left fa-lg"></span>' +
//         '</button>' +
//         '<button type="button" class="prev-month" aria-label="이전 달">' +
//             '<span class="fas fa-angle-left fa-lg"></span>' +
//         '</button>' +
//         '<h2 id="id-grid-label" class="month-year" aria-live="polite">February 2020</h2>' +
//         '<button type="button" class="next-month" aria-label="다음 달">' +
//             '<span class="fas fa-angle-right fa-lg"></span>' +
//         '</button>' +
//         '<button type="button" class="next-year" aria-label="다음 해">' +
...
//         '<button class="dialog-button" value="cancel">취소</button>' +
//         '<button class="dialog-button" value="ok">확인</button>' +
//     '</div>' +
