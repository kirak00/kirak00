...
$(function(){
  ...
  /* 접근성 체크 운영 삭제  */
  try {
    console.log("ㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡ 접근성 색상 체크")
    $.contrastAll()
  } catch (error) {}
  ...
  $("input,select").each(function(){
    ...
    if(this.id != "" && $("[for="+this.id +"]").length > 0){
      return true;
    }
    console.log("ㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡ 인풋 title 체크")
    console.log(this)
  })
  ...
  $("table").each(function(){
    ...
    if(caption.length == 0 ){
      console.log("ㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡ table caption 체크");
      console.log(this);
    }
    var th = $("th",this);
    th.each(function(){
      if(this.getAttribute("scope") == null || this.getAttribute("scope") == ""){
        console.log("ㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡ th scope 체크");
        console.log(this)
      }
    })
  })
